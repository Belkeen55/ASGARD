...
<table>
	<tr>
		<td>
			<table class="cadre">
				<tr>
					<td rowspan="4" align="center" valign="middle"><img src="/server/img/bebe.png" height="64"></td>
					<td rowspan="4"><img src="/server/img/vide.png" height="32"></td>
	...
	<tr>
		<td>
			<td rowspan="4"><img src="/server/img/vide.png" height="75"></td>
		</td>
	</tr>
	<?php
		$reponse = $bdd->query('SELECT Radiateur 
	...
	<tr>
		<td>
			<table class="cadre">
				<tr>
					<td rowspan="4" align="center" valign="middle"><img src="/server/img/salon.png" width="64"></td>
					<td rowspan="4"><img src="/server/img/vide.png" height="32"></td>
